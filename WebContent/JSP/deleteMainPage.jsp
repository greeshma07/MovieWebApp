...
<center>
<h2>Cancel Ticket</h2><hr></hr><br/>
<form name="deleteTicket" action="/project1/StudentServlet" method="post">
<input type="hidden" name="operation" value="deleteTicket"></input>
...
<tr align="center"><td><input type="submit" value="Cancel" onclick="confirmDelete()"></input></td>
