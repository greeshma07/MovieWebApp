...
<div id="main1">
  ...
  <br />
  <center>
  <h2>PAYMENT DETAILS</h2><hr></hr>
  <br />
   <%

int ticketNum=(Integer)request.getAttribute("ticket");
%>
<form name="payment" action="/project1/StudentServlet" >
...
<tr align="left">
<td>Card Type</td>
<td><select name="type" style="width: 146px;">
<option value="null">Select</option>
<option value="masterCard">MasterCard</option>
<option value="visa">Visa</option>
<option value="dankort">Dankort</option>
</select>
<span id="testLevel_err" class="disp_err"></span>
</td>
</tr>
<tr align="left">
<td>Card Number</td>
<td><input type="text" name="cardno" maxlength="20"></input><span id="firstName_err" class="disp_err"></span></td>
</tr>
<tr align="left">
<td>Name on Card</td>
<td><input type="text" name="name" maxlength="20"></input><span id="firstName_err" class="disp_err"></span></td>
</tr>

<tr align="left">
	<td>Expiry Date</td>
	<td><input type="text" size="20" name="exp" id="exp" onmouseout="return validateDob()"><a href="javascript:NewCal	('dob','ddmmyyyy',false,0)"><img src="cal.gif" width="16" height="16" border="0" onmouseout="return validateDob()"></img></a>
	</input></td>
</tr>
<tr align="left">
<td>Security Code:</td>
<td><input type="text" name="sec" maxlength="20"></input><span id="lastName_err" class="disp_err"></span></td>
